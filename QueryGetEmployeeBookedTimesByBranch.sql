...
WHERE E.employee_id = A.employee_id AND A.service_id = s.service_id AND E.branch_id = B.branch_id AND E.branch_id = 1 AND booked_for_date >= '2018-05-21 00:00' AND booked_for_date < '2018-05-22 00:00'
